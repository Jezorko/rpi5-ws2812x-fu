...
int main(void)
{
    ...
    *(volatile uint32_t *)(spi->regbase + DW_SPI_SSIENR) = 0x1;
    ...
    uint8_t data[] = {
        // G R B
        // let's add some sleepy time, see what happens
        0x00, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, // red
        0x00, 0x00, 0xff, 0x00, 0x00, 0x00, 0x00, // blue
        0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // green
        0x00, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, // red
        0x00, 0x00, 0xff, 0x00, 0x00, 0x00, 0x00, // blue
        0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // green
        0x00, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, // red
