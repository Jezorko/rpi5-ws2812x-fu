...
void Java_jezor_jni_RPi5RP1SPI_initializeStrip(int leds_count)
{
...
int Java_jezor_jni_RPi5RP1SPI_getLedsCount() {
    return data_length / 3;
}

int Java_jezor_jni_RPi5RP1SPI_getGreenComponent(int led_index) {
    return data[led_index * 3];
}

int Java_jezor_jni_RPi5RP1SPI_getRedComponent(int led_index) {
    return data[led_index * 3 + 1];
}

int Java_jezor_jni_RPi5RP1SPI_getBlueComponent(int led_index) {
    return data[led_index * 3 + 2];
}

void Java_jezor_jni_RPi5RP1SPI_setLed(int led_index, int red, int green, int blue) {
...
void Java_jezor_jni_RPi5RP1SPI_renderStrip() {
    printf("Rendering:");
...
void Java_jezor_jni_RPi5RP1SPI_closeStrip() {
    close_strip();
    free(data);
}
...
{
    int leds_count = 120;
    Java_jezor_jni_RPi5RP1SPI_initializeStrip(leds_count);

    // LED data
    for (int led_id = 0; led_id < leds_count; ++led_id) {
        if (led_id % 2 == 0) {
            Java_jezor_jni_RPi5RP1SPI_setLed(led_id, 0, 0, 255);
        } else {
            Java_jezor_jni_RPi5RP1SPI_setLed(led_id, 255, 0, 0);
        }
    }

    Java_jezor_jni_RPi5RP1SPI_renderStrip();
    Java_jezor_jni_RPi5RP1SPI_closeStrip();
